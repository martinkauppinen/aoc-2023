...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `43.5µs` | `244.9µs` |
| [Day 2](./src/bin/02.rs) | `57.3µs` | `56.9µs` |
| [Day 3](./src/bin/03.rs) | `346.3µs` | `244.0µs` |
| [Day 4](./src/bin/04.rs) | `299.6µs` | `266.1µs` |
| [Day 5](./src/bin/05.rs) | `67.0µs` | `101.7µs` |
